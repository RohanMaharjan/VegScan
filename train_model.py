...
if __name__ == "__main__":
    ...
    dataloaders = {
        x: torch.utils.data.DataLoader(image_datasets[x],
                                       batch_size=64,
                                       shuffle=True,
                                       num_workers=0)  # Use 0 for Windows safety
        for x in ['train', 'val', 'test']
    }
    ...
    model_ft.classifier.add_module("2", nn.LogSoftmax(dim=1))
    ...
    # Save trained model
    # ----------------------------
    torch.save(model_ft.state_dict(), "mobilenetv2_veggies.pth")
    print("Trained model saved as mobilenetv2_veggies.pth")
